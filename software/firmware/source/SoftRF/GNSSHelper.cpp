...
int GNSS_cnt = 0;
 ...
 /* CFG-MSG */
#ifdef ENABLE_GGXXX
const uint8_t setGLL[] PROGMEM = {0xF0, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01};
const uint8_t setGSV[] PROGMEM = {0xF0, 0x03, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01};
const uint8_t setVTG[] PROGMEM = {0xF0, 0x05, 0x01, 0x01, 0x01, 0x01, 0x01, 0x01};
#else
